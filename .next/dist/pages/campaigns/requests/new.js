...
var RequestNew = function (_Component) {
        ...
        return _regenerator2.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 10:
                _routes.Router.push('/campaigns/' + _this.props.address + '/requests');
                _context.next = 16;
                break;
  ...
  (0, _createClass3.default)(RequestNew, [{
    ...
    value: function render() {
      ...
      })), _react2.default.createElement(_semanticUiReact.Message, { error: true, header: 'Oops!', content: this.state.errorMessage }), _react2.default.createElement(_semanticUiReact.Button, { primary: true, loading: this.state.loading }, 'Create')));
    }
  }], [{
    key: 'getInitialProps',
    value: function () {
